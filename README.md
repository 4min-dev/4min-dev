...
За время своей деятельности успел поработать над множеством Frontend проектов. 
Помимо опыта разработки клиентской части приложения, имею так же опыт разработки бекенд части приложения. 
